...
class NotesMod(loader.Module):
    ...
    strings = {
        ...
        "no_note": "<b>Нотатку не знайдено</b>",
        "save_what": "<b>Що потрібно зберегти?</b>",
        "what_name": "<b>Як буде називатися нотатка?</b>",
        "saved": "<b>Нотатку збережено як:</b> <code>{}</code>",
        "notes_header": "<b>Збережені нотатки:</b>\n\n",
        "notes_item": "<b>▷</b> <code>{}</code>",
        "delnote_args": "<b>Яку нотатку потрібно видалити?</b>",
        "delnote_done": "<b>Нотатку видалено!</b>",
        "delnotes_none": "<b>Нотаток немає...</b>",
        "delnotes_done": "<b>УСІ НОТАТКИ ВИДАЛЕНО</b>",
        "notes_none": "<b>Нотаток немає...</b>",
    }
    ...
    async def findnotecmd(self, message):
        ...
        await message.edit(
            f'<b>Нотатка</b> "<code>{args[0]}</code>" <a href="{link}">знаходиться тут.</a>'
        )
