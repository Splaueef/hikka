...
eval "cd && git clone https://github.com/Splaueef/hikka && cd Hikka"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/Splaueef/hikka/raw/master/banner.sh) && cd ~/Hikka && python3 -m hikka' > ~/.bash_profile"
